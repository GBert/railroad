...
On the main screen one can open the configuration of the setting with the icon ![](../menu_multipleunit.png). Alternatively at the selected locomotive one can use the icon to get directly to the settings of that locomotive.

## Basics
![](multipleunits_basics_en.png)
...
## Functions
![](multipleunits_functions_en.png)
