# Konfiguration der Lokomotiven
Jede Lokomotive auf der Modellbahn muss in RailControl korrekt konfiguriert werden, damit diese gesteuert werden kann.

Im Hauptbildschirm kann man über das Icon ![](../menu_loco.png) zur Konfiguration der Lokomotiven gelangen. Alternativ kann bei der ausgewählten Lokomotive das Icon ![](../menu_settings.png) gewählt werden.

## Basisdaten
![](locomotives_basics_de.png)
