...
/* TextHintIntellibox2 */ { "Intellibox II is currently under development.<br>Under Linux the virtual serial port is usually /dev/ttyUSB0.<br>Please set the Intellibox II to a communication speed of 115200 (default).", "Die Anbindung and die Intellibox II ist in Entwicklung.<br>Unter Linux ist der erstellte virtuelle COM-Port üblicherweise /dev/ttyUSB0.<br>Die Kommunikationsgeschwindigkeit ist in der Intellibox II auf 115200 zu setzen (standard).", "La conneción con Intellibox II está en desarollo.<br>Sobre Linux el puerto virtual normalmente es /dev/ttyUSB0.<br>Se tiene que usar una velocidad de comunicación de 115200 en Intellibox II (defecto)." },
